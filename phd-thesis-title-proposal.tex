...
% 150--250 words.
A modern and innovative vision of cloud systems foster a new perspective involving not only devices at the edge,
and the cloud but also multiple tiers between them.
%
This vision, known in the literature as the Edge-cloud Continuum (ECC),
aims to solve the limitations of traditional cloud systems by providing a more flexible and scalable infrastructure to support modern applications.
%
Several approaches have been proposed to exploit the ECC in IoT applications, Collective Adaptive Systems (CAS), and other modern paradigms,
but they are typically tailored to specific scenarios and applications,
and addressing specific requirements,
making them difficult to generalise and reuse in other contexts.
%
With this PhD thesis,
I aim to develop a general and comprehensive framework and engineering approach to support the next generation of IoT and CAS in the ECC,
providing a general model designed at the intersection of other research areas,
like multi-tier programming models and choreographies, 
AI-based techniques,
and self-organisation principles.
