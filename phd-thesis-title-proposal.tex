...
The main goal of my PhD is to develop and investigate innovative engineering approaches to develop and deploy \ac{cas}~\cite{} in emergent and dynamic environments,
like the \ac{ecc}~\cite{DBLP:journals/access/MoreschiniPLNHT22}.
%
With this research line I aim to provide a general but effective framework supporting the entire workflow of \ac{cas},
...
The \emph{aggregate computing} approach~\cite{} to \ac{cas} engineering,
comprises a \emph{macro-programming} model and language~\cite{} based on computational fields~\cite{},
...
%
Pulverization~\cite{} defines a partitioning model for neatly separate the self-organising behavior of the system from the actual deployment.
%
...
which is founded by the Italian PRIN project ``CommonWears'' (2020HCWWLP).

With this thesis,
I aim to extend the current state of the art by providing a comprehensive framework to support the design and deployment of \ac{cas} in the \ac{ecc},
